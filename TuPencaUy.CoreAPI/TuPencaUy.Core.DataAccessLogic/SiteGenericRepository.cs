...
{
  public class SiteGenericRepository<TEntity> : IGenericRepository<TEntity>
    where TEntity : LogicDelete
  {
    internal SiteDbContext _context;
    internal DbSet<TEntity> _dbSet;

    public SiteGenericRepository(SiteDbContext context)
    {
      _context = context;
