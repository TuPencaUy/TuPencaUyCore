...
namespace TuPencaUy.Platform.DAO.Migrations
{
    ...
    [Migration("20240520003221_Team-On-Sport")]
    partial class TeamOnSport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TuPencaUy.Core.DAO.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TuPencaUy.Core.DAO.Match", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TuPencaUy.Core.DAO.Sport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TuPencaUy.Core.DAO.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TuPencaUy.Core.DAO.Match", b =>
                {
                    b.HasOne("TuPencaUy.Core.DAO.Event", null)
                        .WithMany("Matches")
